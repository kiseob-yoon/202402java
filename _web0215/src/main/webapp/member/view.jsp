...
// 게시글 데이터를 담을 변수 정의
	...
	List<Comment> list = dao1.selectList();
		...
		<div class="mb-3"
			...
			<div class="container" style="padding-top: 50px;">
				...
				<div class="btn-group">
					...
					type="button" class="btn btn-primary" value="삭제"
					onclick="location.href='delete.jsp?num=<%=num%>'">
					
					<svg xmlns="http://www.w3.org/2000/svg" width="48" height="40" fill="currentColor" class="bi bi-hand-thumbs-up" style="text-align: right; margin: 10px 0px 0px 435px" viewBox="0 0 16 16">
					...
					<span style="margin: 20px 0px 0px 5px;">0</span>
					
					<svg xmlns="http://www.w3.org/2000/svg" width="48" height="40" fill="currentColor" class="bi bi-hand-thumbs-down" style="text-align: right; margin: 10px 0px 0px 0px" viewBox="0 0 16 16">
