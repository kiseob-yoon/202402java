...
<head><script src="assets/js/color-modes.js"></script>
    ...
    <style>
      ...
      .custom-popup-button {
    	background-color: #007bff; /* 원하는 파란색 계열의 색상으로 변경하세요 */
    	color: #ffffff; /* 텍스트 색상을 흰색으로 설정 */
    	border-color: #007bff; /* 테두리 색상도 설정 (선택 사항) */
        }
    </style>
...
%>		<main class="container d-flex align-items-center justify-content-center" style="height: 100vh;">
        ...
        <img class="mb-4" src="${path}/assets/brand/door-open.svg" alt="" width="72" height="57">
    	<h1 class="h3 mb-3 fw-normal">접속중</h1>
            <%=(String)session.getAttribute("userName")%>님
        

        <button class="btn btn-primary w-100 py-2" type="submit">로그아웃</button></p>
        <button class="btn btn-primary w-100 py-2" type="button"value="회원정보 수정" 
                   onclick="window.open('member_update_form.jsp', 'popup', 
                                        'width=600, height=400')">회원정보 수정</button>
